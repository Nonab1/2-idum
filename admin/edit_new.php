                        ...
                        <div class="col-12">
                          <div class="card">
                            ...
                            <div class="card-content">
                              <div class="card-body">
                                <form class="form" action="update_new.php" method="post" enctype="multipart/form-data">
                                  <div class="row">
                                    <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        <input type="text" style="display: none;" name="id" value="<?= $item['id'] ?>">
                                        <label for="header">Header</label>
                                        <input type="text" id="header" name="header" value="<?= $item['header'] ?>" class="form-control" placeholder="Header" requared>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                      <div class="form-group">
