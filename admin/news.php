                        ...
                        <tbody>
                          <?php foreach ($data as $item) : ?>
                            <tr>
                              ...
                              <td><?= $item['time'] ?></td>
                              <td>
                                <a href="edit_new.php?id=<?= $item['id'] ?>" class="btn btn-success">Edit</a>
                                <a href="delete_new.php?id=<?= $item['id'] ?>" onclick="return confirm('<?= $item['header'] ?>ni ochirmoqchimidiz?')" class="btn btn-danger">Delete</a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
